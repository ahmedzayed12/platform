...
SECTOR_OPTIONS = ["غير محدد", "عام", "خاص", "أهلي/غير ربحي", "دولي", "أكاديمي", "عمل حر"]
...
COUNTRIES = [
    "مصر", "السعودية", "الإمارات", "قطر", "الكويت", "البحرين", "عُمان", "الأردن", "فلسطين",
    "تركيا", "ألمانيا", "المملكة المتحدة", "الولايات المتحدة", "كندا", "أستراليا", "فرنسا", "إيطاليا",
    "السودان", "ليبيا", "اليمن", "العراق", "سوريا", "لبنان", "أخرى",
]
COUNTRY_CITY_OPTIONS = {
    "مصر": ["القاهرة", "الجيزة", "الإسكندرية", "القليوبية", "الدقهلية", "الشرقية", "الغربية", "المنوفية", "البحيرة", "كفر الشيخ", "دمياط", "بورسعيد", "الإسماعيلية", "السويس", "شمال سيناء", "جنوب سيناء", "بني سويف", "الفيوم", "المنيا", "أسيوط", "سوهاج", "قنا", "الأقصر", "أسوان", "البحر الأحمر", "الوادي الجديد", "مطروح", "أخرى"],
    "السعودية": ["الرياض", "جدة", "مكة المكرمة", "المدينة المنورة", "الدمام", "الخبر", "الطائف", "تبوك", "بريدة", "أبها", "جازان", "حائل", "نجران", "أخرى"],
    "الإمارات": ["أبوظبي", "دبي", "الشارقة", "عجمان", "رأس الخيمة", "الفجيرة", "أم القيوين", "العين", "أخرى"],
    "قطر": ["الدوحة", "الريان", "الوكرة", "الخور", "أم صلال", "الشمال", "دخان", "أخرى"],
    "الكويت": ["مدينة الكويت", "حولي", "السالمية", "الفروانية", "الأحمدي", "الجهراء", "مبارك الكبير", "أخرى"],
    "البحرين": ["المنامة", "المحرق", "الرفاع", "مدينة عيسى", "سترة", "أخرى"],
    "عُمان": ["مسقط", "صلالة", "صحار", "نزوى", "صور", "الرستاق", "أخرى"],
    "الأردن": ["عمّان", "إربد", "الزرقاء", "العقبة", "السلط", "مادبا", "أخرى"],
    "فلسطين": ["غزة", "رام الله", "القدس", "نابلس", "الخليل", "جنين", "بيت لحم", "أخرى"],
    "تركيا": ["إسطنبول", "أنقرة", "إزمير", "بورصة", "أنطاليا", "قونية", "أخرى"],
    "ألمانيا": ["برلين", "ميونخ", "هامبورغ", "فرانكفورت", "كولونيا", "دوسلدورف", "شتوتغارت", "لايبزيغ", "أخرى"],
    "المملكة المتحدة": ["لندن", "مانشستر", "برمنغهام", "ليفربول", "ليدز", "غلاسكو", "إدنبرة", "أخرى"],
    "الولايات المتحدة": ["نيويورك", "واشنطن", "لوس أنجلوس", "شيكاغو", "هيوستن", "بوسطن", "سان فرانسيسكو", "أخرى"],
    "كندا": ["تورونتو", "مونتريال", "فانكوفر", "أوتاوا", "كالغاري", "إدمونتون", "أخرى"],
    "أستراليا": ["سيدني", "ملبورن", "بريزبن", "بيرث", "أديلايد", "كانبرا", "أخرى"],
    "فرنسا": ["باريس", "مارسيليا", "ليون", "تولوز", "نيس", "ليل", "أخرى"],
    "إيطاليا": ["روما", "ميلانو", "نابولي", "تورينو", "فلورنسا", "بولونيا", "أخرى"],
    "السودان": ["الخرطوم", "أم درمان", "بحري", "بورتسودان", "الأبيض", "أخرى"],
    "ليبيا": ["طرابلس", "بنغازي", "مصراتة", "سبها", "الزاوية", "أخرى"],
    "اليمن": ["صنعاء", "عدن", "تعز", "الحديدة", "إب", "أخرى"],
    "العراق": ["بغداد", "البصرة", "الموصل", "أربيل", "النجف", "كربلاء", "أخرى"],
    "سوريا": ["دمشق", "حلب", "حمص", "حماة", "اللاذقية", "طرطوس", "أخرى"],
    "لبنان": ["بيروت", "طرابلس", "صيدا", "صور", "زحلة", "جبيل", "أخرى"],
    "أخرى": ["غير محدد", "أخرى"],
}
...
st.markdown(
    ...
    <style>
        ...
        /* ================================================================
           قاعدة ثابتة: لا نغيّر اتجاه هيكل Streamlit نفسه.
           الاتجاه العربي يطبّق فقط على محتوى التطبيق، حتى لا يحدث انزياح
           أفقي على الموبايل أو عند تصغير المتصفح.
           ================================================================ */
        ...
        [data-testid="stSidebar"] {
            background: linear-gradient(180deg, #0f172a 0%, #1e3a8a 56%, #0f766e 100%) !important;
        }
        ...
        .stButton, .stDownloadButton, .stDataFrame, [data-testid="stTable"] {
            direction: rtl !important;
            text-align: right !important;
            font-family: 'Cairo', Tahoma, Arial, sans-serif !important;
        }
        ...
        /* لا نطبّق خط Cairo على أيقونات Streamlit الداخلية حتى لا تظهر كنص */
        [data-testid="collapsedControl"] *,
        [data-testid="stToolbar"] *,
        [data-testid="stHeader"] *,
        span[data-testid="stIconMaterial"],
        [class*="material"], [class*="Material"] {
            font-family: 'Material Symbols Rounded', 'Material Symbols Outlined', 'Material Icons', Arial, sans-serif !important;
            direction: ltr !important;
        ...
        .hero h1 {
            font-size: clamp(1.25rem, 4.5vw, 2.1rem) !important;
        ...
        .hero p {
            font-size: clamp(.82rem, 2.5vw, 1.04rem) !important;
            margin: 0 !important;
        ...
        .metric-label {font-size: 0.86rem !important; color: #64748b !important; font-weight: 800 !important;}
        .metric-value {font-size: clamp(1.25rem, 5vw, 1.85rem) !important; color: var(--ink) !important; font-weight: 900 !important; margin-top: 6px !important; direction: ltr !important; text-align: right !important;}
        .metric-note {font-size: 0.78rem !important; color: #94a3b8 !important; margin-top: 6px !important; line-height: 1.6 !important;}
        .soft-box {
            padding: 18px 20px !important;
            line-height: 1.95 !important;
        }
        .info-box {background: #eff6ff !important; border-color:#bfdbfe !important;}
        .success-box {background: #f0fdf4 !important; border-color:#bbf7d0 !important;}
        .warning-box {background: #fffbeb !important; border-color:#fde68a !important;}
        .danger-box {background: #fef2f2 !important; border-color:#fecaca !important;}
        .pill {
        ...
        div[data-testid="stMetricValue"] {direction:ltr !important; text-align:right !important; font-weight:900 !important;}
        ...
        /* ================================================================
           Mobile and small-window layout
           ================================================================ */
        ...
        @media (max-width: 480px) {
            ...
            .section-subtitle { font-size: .78rem !important; }
            .metric-label { font-size: .78rem !important; }
            .metric-note { font-size: .72rem !important; }
            [data-testid="stSidebar"] {
...
def demo_records() -> pd.DataFrame:
    ...
    for i, name in enumerate(names, start=1):
        ...
        demo_countries = ["مصر", "السعودية", "الإمارات", "قطر", "الكويت", "ألمانيا", "المملكة المتحدة", "الولايات المتحدة"]
        country = demo_countries[(i - 1) % len(demo_countries)]
        city_options = [x for x in COUNTRY_CITY_OPTIONS.get(country, ["غير محدد", "أخرى"]) if x not in ["غير محدد", "أخرى"]]
        city = city_options[(i - 1) % len(city_options)] if city_options else "غير محدد"
        rows.append({
...
def filtered_df(df: pd.DataFrame, college: str, department: str, year_range: Tuple[int, int], status: List[str], search: str) -> pd.DataFrame:
    ...
    if search.strip():
        ...
        searchable_cols = ["full_name", "national_id", "email", "phone", "college", "department", "major", "employer", "job_title", "country", "city"]
...
def options_with_current(options: List[str], current_value, insert_before_other: bool = True) -> List[str]:
    """يحافظ على القيم القديمة/المستوردة حتى لو لم تكن ضمن القوائم القياسية."""
    out = list(dict.fromkeys([safe_str(x) for x in options if not is_blank(x)]))
    current = safe_str(current_value).strip()
    if current and current not in out:
        if insert_before_other and "أخرى" in out:
            out.insert(out.index("أخرى"), current)
        else:
            out.append(current)
    return out or ["غير محدد"]


def city_options_for_country(country: str, current_city="") -> List[str]:
    base = COUNTRY_CITY_OPTIONS.get(safe_str(country, "أخرى"), COUNTRY_CITY_OPTIONS["أخرى"])
    return options_with_current(base, current_city, insert_before_other=True)


def render_location_inputs(prefix: str, defaults: Dict) -> Tuple[str, str]:
    """اختيار الدولة والمدينة بمنطق صحيح: كل دولة تعرض مدنها/محافظاتها، مع دعم الإدخال الحر."""
    stored_country = safe_str(defaults.get("country"), "مصر")
    stored_city = safe_str(defaults.get("city"), "")
    country_options = options_with_current(COUNTRIES, stored_country, insert_before_other=True)
    country_choice = st.selectbox(
        "الدولة",
        country_options,
        index=get_index(stored_country, country_options),
        key=f"{prefix}_country_choice",
        help="اختر الدولة أولًا، وسيتم عرض المدن/المحافظات المناسبة لها بدل عرض محافظات مصر لكل الدول.",
    )

    if country_choice == "أخرى":
        country_value = st.text_input(
            "اكتب اسم الدولة",
            value="" if stored_country in COUNTRIES else stored_country,
            key=f"{prefix}_country_other",
            placeholder="مثال: هولندا، النمسا، المغرب...",
        ).strip() or "أخرى"
        city_value = st.text_input(
            "المدينة / المحافظة",
            value="" if stored_city in ["غير محدد", "أخرى"] else stored_city,
            key=f"{prefix}_city_free",
            placeholder="اكتب المدينة أو المحافظة",
        ).strip() or "غير محدد"
        return country_value, city_value

    city_options = city_options_for_country(country_choice, stored_city)
    city_choice = st.selectbox(
        "المدينة / المحافظة",
        city_options,
        index=get_index(stored_city, city_options),
        key=f"{prefix}_city_choice_{country_choice}",
        help="القائمة تتغير حسب الدولة المختارة. اختر أخرى إذا لم تجد المدينة.",
    )
    if city_choice == "أخرى":
        custom_default = stored_city if stored_city and stored_city not in COUNTRY_CITY_OPTIONS.get(country_choice, []) and stored_city != "أخرى" else ""
        city_value = st.text_input(
            "اكتب المدينة / المحافظة",
            value=custom_default,
            key=f"{prefix}_city_other_{country_choice}",
            placeholder="اكتب المدينة أو المحافظة يدويًا",
        ).strip() or "أخرى"
    else:
        city_value = city_choice
    return country_choice, city_value
...
def build_graduate_form(prefix: str, defaults: Optional[Dict] = None) -> Dict:
    ...
    with c3:
        country, city = render_location_inputs(prefix, defaults)
    ...
    with c4:
        college_options = options_with_current(COLLEGES, defaults.get("college", "كلية الحاسبات والمعلومات"))
        college = st.selectbox("الكلية", college_options, index=get_index(defaults.get("college", "كلية الحاسبات والمعلومات"), college_options), key=f"{prefix}_college")
    dept_options = options_with_current(DEPARTMENTS_BY_COLLEGE.get(college, ["أخرى"]), defaults.get("department"))
    with c5:
    ...
    with c7:
        status_options = options_with_current(STATUS_OPTIONS, defaults.get("current_status", "موظف"))
    ...
    with c8:
        related_options = options_with_current(RELATED_OPTIONS, defaults.get("job_related_to_major", "غير محدد"))
    ...
    with c11:
        sector_options = options_with_current(SECTOR_OPTIONS, defaults.get("employment_sector", "غير محدد"))
    ...
    return {
        ...
        "business_start_year": int(business_start_year) if int(business_start_year) > 0 else None,
        "business_employees": int(business_employees) if current_status == "صاحب مشروع خاص" else None,
        "postgraduate_program": postgraduate_program.strip(),
        "first_job_months": int(first_job_months) if current_status in ["موظف", "صاحب مشروع خاص", "طالب دراسات عليا"] else None,
        "monthly_income": float(monthly_income) if float(monthly_income) > 0 else None,
        "country": country,
        "city": city,
...
def render_graduates_management(df: pd.DataFrame) -> None:
    ...
    with sub1:
        ...
        st.caption("ملاحظة تشغيلية: اختيار المدينة/المحافظة يتغير فورًا حسب الدولة المختارة؛ لذلك لا تُعرض محافظات مصر إلا عند اختيار مصر.")
        if st.button("حفظ الخريج", key="save_add_graduate", type="primary"):
    ...
    with sub2:
        if df.empty:
            ...
            selected = st.selectbox("اختر الخريج المراد تعديله", list(options.keys()), key="update_record_selector")
            selected_id = options[selected]
            selected_row = df[df["id"] == selected_id].iloc[0].to_dict()
            row = build_graduate_form(f"update_{selected_id}", selected_row)
            st.caption("بعد تغيير الدولة ستتغير قائمة المدينة/المحافظة مباشرة قبل الحفظ.")
            if st.button("تحديث البيانات", key=f"save_update_{selected_id}", type="primary"):
...
def render_database(df: pd.DataFrame, surveys: pd.DataFrame) -> None:
    ...
    if df.empty:
        ...
        return
    years = pd.to_numeric(df["graduation_year"], errors="coerce").dropna()
    if years.empty:
        min_year, max_year = 1980, 2035
    else:
...
def main() -> None:
    ...
    st.sidebar.markdown(
        ...
        <div class="sidebar-stat-grid">
            <div class="sidebar-stat-card">
                <div class="sidebar-stat-label">عدد الخريجين المسجلين</div>
                <div class="sidebar-stat-value">{len(df):,}</div>
            </div>
            <div class="sidebar-stat-card">
                <div class="sidebar-stat-label">عدد الاستبيانات المكتملة</div>
                <div class="sidebar-stat-value">{len(surveys):,}</div>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown("<div class='sidebar-label'>التنقل بين أقسام المنصة</div>", unsafe_allow_html=True)
    st.sidebar.markdown("<div class='sidebar-help'>تم نقل التبويبات إلى القائمة الجانبية حتى لا تتداخل عند تصغير الشاشة أو فتحها من الموبايل والتابلت.</div>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div class='pill'>القسم الحالي: {selected_page}</div>", unsafe_allow_html=True)

    if selected_page == "🏠 لوحة المؤشرات":
        render_dashboard(df, surveys)
    elif selected_page == "👥 إدارة الخريجين":
        render_graduates_management(df)
    elif selected_page == "🗃️ قاعدة البيانات":
        render_database(df, surveys)
    elif selected_page == "📝 استبيانات الأثر":
        render_surveys(df, surveys)
    elif selected_page == "📊 تحليلات متقدمة":
        render_analytics(df, surveys)
    elif selected_page == "📑 التقارير":
        render_reports(df, surveys)
    elif selected_page == "📥 استيراد وتصدير":
