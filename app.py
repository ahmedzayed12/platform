...
st.markdown(
    ...
    <style>
        ...
        [data-testid="stSidebar"] .sidebar-stat-card {
        ...
        /* ------------------------------------------------------------------
           Responsive UI: desktop / tablet / mobile / resized browser
           ------------------------------------------------------------------ */
        *, *::before, *::after {
        ...
        @media (max-width: 960px) {
            ...
            .hero p, .section-subtitle, .soft-box {
        ...
        @media (max-width: 720px) {
            ...
            [data-testid="stSidebar"] {
                min-width: min(100vw, 380px) !important;
            }
            [data-testid="stSidebar"] .sidebar-stat-value {
        ...
        /* ==================================================================
           MOBILE-FIRST HARD FIX
           سبب الإصلاح: لا نضع direction: rtl على حاويات Streamlit الهيكلية
           لأن ذلك يكسر موضع الـ sidebar ويظهر زر الفتح كنص على الموبايل.
           ================================================================== */
        html, body, .stApp,
        [data-testid="stAppViewContainer"],
        [data-testid="stMain"],
        ...
        [data-testid="stMain"] .stMultiSelect,
        [data-testid="stMain"] .stRadio,
        [data-testid="stMain"] .stCheckbox,
        ...
        /* لا تطبق خط القاهرة على أيقونات Streamlit الداخلية */
        [data-testid="collapsedControl"] *,
        [data-testid="stToolbar"] *,
        ...
        /* إخفاء النص الخام keyboard_double_arrow_left إن ظهر واستبداله برمز واضح */
        ...
        @media (max-width: 768px) {
            ...
            [data-testid="stMain"] .block-container {
                width: 100% !important;
                max-width: 100% !important;
                padding: .55rem .55rem 1.6rem .55rem !important;
                margin: 0 !important;
            }
            div[data-testid="stHorizontalBlock"] {
                display: block !important;
        ...
        @media (max-width: 420px) {
            ...
            .hero h1 { font-size: .96rem !important; }
            .hero p { font-size: .76rem !important; }
            .metric-value { font-size: 1.15rem !important; }
            .section-title { font-size: .98rem !important; }
        }
